...
\caption{Comparison of velocities and pressure predicted by Linear Stability analysis and by explicitly solving \eqref{averaged_eq}. The comparison are made at $\bar{T}=82$ and two different locations, where velocities are $\pi/2$ out of phase with each other.}
