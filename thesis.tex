%\documentclass[12pt,twoside]{report}  % SANE PRINTING OUTPUT
...
\usepackage[Bjarne]{acn_fncychap}
\include{acn_chapter_titles}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{abstract}
  ...
  \addtocounter{page}{-1}  % Do you want this page to exist in the numbering?
\end{abstract}
